...
type ToolbarItemId = 'undo' | 'redo' | 'separator' | 'paragraphStyle' | 'fontFamily' | 'fontSize' | 'bold' | 'italic' | 'underline' | 'strikethrough' | 'superscript' | 'subscript' | 'code' | 'textColor' | 'highlight' | 'clearFormatting' | 'alignLeft' | 'alignCenter' | 'alignRight' | 'alignJustify' | 'bulletList' | 'orderedList' | 'taskList' | 'indent' | 'outdent' | 'blockquote' | 'horizontalRule' | 'link' | 'image' | 'table' | 'pageBreak';
/**
...
export type { DocumentJSON as D, EditorMode as E, FeatureFlags as F, PageConfig as P, SaveStatus as S, ThemeTokens as T, EditorStrings as a, PageSize as b, ToolbarConfig as c, ToolbarItemId as d };
