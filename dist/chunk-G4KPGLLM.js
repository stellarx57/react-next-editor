import { buildPrintDocument } from './chunk-ROUECI7Q.js';
import { sanitizeUrl } from './chunk-T4KZ6KN3.js';
import { DEFAULT_PAGE, resolvePageDimensions } from './chunk-LBY6ULPF.js';
...
async function exportDocument(doc, format, options = {}) {
  ...
  switch (format) {
    ...
    case "txt":
      ...
      return;
    case "html": {
      const { buildPrintDocument: buildPrintDocument2 } = await import('./html-ZJ2HILQJ.js');
      downloadText(
        buildPrintDocument2(doc, options.page ?? (await import('./defaults-AK7D23WX.js')).DEFAULT_PAGE, options.title),
        ensureExt(base, "html"),
        "text/html"
      );
      return;
...
export { documentToDocxBlob, documentToDocxBuffer, documentToText, downloadBlob, downloadText, exportDocument, printDocumentToPdf };
//# sourceMappingURL=chunk-G4KPGLLM.js.map
//# sourceMappingURL=chunk-G4KPGLLM.js.map